...
output "task_security_group_id" {
  description = "Security group attached to the tasks. Pass this to a database or cache module's allowed_security_group_ids to let the service reach it."
  value       = aws_security_group.task.id
}

output "task_role_arn" {
  description = "ARN of the task role — the runtime identity application code assumes."
...
output "target_group_arn_suffix" {
  description = "Target group ARN suffix, for CloudWatch dimensions and autoscaling resource labels."
